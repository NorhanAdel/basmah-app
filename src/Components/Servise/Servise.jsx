          ...
          <div className="servise_item1">
            <div className="service_item grey">
              <h1 className="service_title">
                نمارس فن تصوير ومونتاج الفيديوهات
              </h1>
              <p className="service_sub">
                نحوّل الأفكار إلى لقطات تنبض بالحياة، ونمزج بين الإبداع
                والاحترافية لتوصيل رسالتك بأفضل صورة. نؤمن بأن صناعة الفيديوهات
                تشبه لوحة فنية متحركة، تُعبّر عن رؤيتك وتترك أثرًا لا يُنسى، كما
                قال المخرج البريطاني نيفيل برودي: "التصميم الرقمي يشبه الرسم،
                باستثناء أن الطلاء لا يجف أبدًا"
              </p>
              <img src={IMG} alt="" />
            </div>
            <div className="service_item orange">
              <h1 className="service_title"> نمارس فن تصاميم الجرافيك</h1>
              <p className="service_sub">
                نبتكر تصاميم تعكس هويتك وتمزج بين الجمال والإبداع لتوصيل رسالتك
                بأفضل صورة. نؤمن بأن تصاميم الجرافيك تشبه لوحة فنية متقنة،
                تُعبّر عن رؤيتك وتترك أثرًا لا يُنسى،  
              </p>
              <img src={IMG2} alt="" />
            </div>
          </div>
